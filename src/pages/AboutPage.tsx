...
const AboutPage = () => {
  return (
    <>
      <aside className="mx-auto bg-third flex justify-center items-center gap-2 pt-2 sm:py-14">
        <a
          target="_blank"
        ...
        <button className="text-gray-900 text-sm font-light hover:underline md:text-lg hover:scale-105 transition">
          View
      ...
      <section className="min-h-screen w-full bg-third flex flex-col items-center p-10 text-primary py-14 px-10 sm:px-20 sm:py-4 sm:flex-row sm:items-start sm:h-[50vh] md:h-[90vh] ">
        <div className="flex w-full h-72 relative mb-4 shrink-0 justify-center sm:w-[33%] sm:flex-col sm:justify-start md:pr-10">
          <article>
        ...
        <div className="sm:w-[67%]">
          <h2 className="font-bold text-7xl tracking-[-0.3rem] lg:text-8xl">
            Jesus Chacon
          </h2>
          ...
          <p className="text-sm font-light text-third md:text-lg lg:text-2xl sm:border sm:border-transparent sm:border-b-gray-300 sm:pb-10">
            ...
            three years knowing the programming language and six months in the
            working environment. I consider myself a person passionate about
            learning and having communication skills.
          </p>
          <article>
            <h2 className="text-3xl font-bold py-10 lg:text-4xl">
              Experience
            </h2>
            <ul>
