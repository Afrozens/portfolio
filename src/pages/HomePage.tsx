    ...
    <main id="#" className="sm:flex overflow-hidden">
      <section className="h-[80vh] w-full flex flex-col justify-center bg-primary p-16 sm:w-[67%] sm:h-[60vh] lg:h-screen">
        <div className="sm:pt-8 w-full ">
          <AnimatedWords line1="Hi, i'm 🖐" line2="Frontend" line3="Developer" classText="text-secundary text-5xl font-bold font-inter tracking-widest my-4 lg:text-8xl"/>
          <motion.p
          ...
          >
            Discover my professional expertise and accomplishments by exploring my portfolio.
          </motion.p>
        </div>
        <Link to="about" spy={true} smooth={true} offset={-100} duration={300}>
          <img src={ArrowScroll} alt="arrow scroll" className="h-16 w-16 absolute animate-bounce bottom-40 right-[40%] sm:bottom-[50%] lg:bottom-0 lg:left-[50%] cursor-pointer"/>
          </Link>
      </section>
